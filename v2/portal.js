...
function shootGoDetails(tid){
  ...
  box.innerHTML='<div class="shoot-wiz">'+shootStepBar(2)
    ...
    +'<div class="shoot-form">'
      +'<div class="shoot-row"><div class="shoot-field"><label>Voornaam *</label><input type="text" id="shoot-voornaam-'+tid+'" value="'+escapeHtml(pf.voornaam||'')+'" placeholder="Jouw voornaam" autocomplete="given-name" autocapitalize="words"></div><div class="shoot-field"><label>E-mailadres *</label><input type="email" id="shoot-email-'+tid+'" value="'+escapeHtml(pf.email||'')+'" placeholder="jij@merk.be" inputmode="email" autocomplete="email" autocapitalize="off" spellcheck="false"></div></div>'
      ...
      +(ctx.locatieVast
        ...
        +'<div class="shoot-row-loc"><input type="text" id="shoot-straat-'+tid+'" placeholder="Straat + nummer" autocomplete="off" oninput="shootClearCoords(\''+tid+'\')"><input type="text" id="shoot-postcode-'+tid+'" placeholder="Postcode" maxlength="4" inputmode="numeric" autocomplete="postal-code" oninput="shootClearCoords(\''+tid+'\')"><input type="text" id="shoot-gemeente-'+tid+'" placeholder="Gemeente" autocomplete="off" oninput="shootClearCoords(\''+tid+'\')"></div>')
      +'<div class="shoot-row"><div class="shoot-field"><label>Contactpersoon op locatie (indien anders dan jij)</label><input type="text" id="shoot-cnaam-'+tid+'" placeholder="Naam" autocomplete="name" autocapitalize="words"></div><div class="shoot-field"><label>GSM contactpersoon</label><input type="tel" id="shoot-cgsm-'+tid+'" placeholder="04XX XX XX XX" inputmode="tel" autocomplete="tel"></div></div>'
